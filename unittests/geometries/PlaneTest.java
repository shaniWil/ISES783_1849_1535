...
class PlaneTest {
    ...
    Plane plane = new Plane(po1,po2,po3);
    Plane plane2 =new Plane(po1,v1);

    @Test
    public void testConstructor() {
        // ============ Equivalence Partitions Tests ==============
        // TC01: Test that the constructor proper
        assertEquals(plane2, plane,"ERROR: constructor() the plane is incorrect");
    ...
    public void testGetNormal() {
        Vector normal = plane.getNormal(po3);
        // ============ Equivalence Partitions Tests ==============
